...
CREATE TABLE IF NOT EXISTS `cadastro_imobiliario_it575`.`fisica` (
  ...
  PRIMARY KEY (`id_pessoa`, `rg`),
  INDEX `fk_fisica_pessoa1_idx` (`id_pessoa` ASC) VISIBLE,
  CONSTRAINT `fk_fisica_pessoa1`
    FOREIGN KEY (`id_pessoa`)
    REFERENCES `cadastro_imobiliario_it575`.`pessoa` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cadastro_imobiliario_it575`.`juridica` (
  ...
  PRIMARY KEY (`id_pessoa`, `cnpj`),
  UNIQUE INDEX `cnpj_UNIQUE` (`cnpj` ASC) VISIBLE,
  INDEX `fk_juridica_pessoa1_idx` (`id_pessoa` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `cadastro_imobiliario_it575`.`imovel_juridica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cadastro_imobiliario_it575`.`imovel_juridica` (
  `id_pessoa_juridica` INT NOT NULL,
  `id_imovel` INT NOT NULL,
  `juridica_cnpj` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id_pessoa_juridica`, `id_imovel`, `juridica_cnpj`),
  INDEX `fk_imovel_has_juridica_juridica1_idx` (`id_pessoa_juridica` ASC, `juridica_cnpj` ASC) VISIBLE,
  INDEX `fk_imovel_has_juridica_imovel1_idx` (`id_imovel` ASC) VISIBLE,
  CONSTRAINT `fk_imovel_has_juridica_imovel1`
    FOREIGN KEY (`id_imovel`)
    REFERENCES `cadastro_imobiliario_it575`.`imovel` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_imovel_has_juridica_juridica1`
    FOREIGN KEY (`id_pessoa_juridica` , `juridica_cnpj`)
    REFERENCES `cadastro_imobiliario_it575`.`juridica` (`id_pessoa` , `cnpj`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cadastro_imobiliario_it575`.`fisica_imovel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cadastro_imobiliario_it575`.`fisica_imovel` (
  `id_pessoa_fisica` INT NOT NULL,
  `id_imovel` INT NOT NULL,
  `fisica_rg` VARCHAR(8) NOT NULL,
  PRIMARY KEY (`id_pessoa_fisica`, `id_imovel`, `fisica_rg`),
  INDEX `fk_fisica_has_imovel_imovel1_idx` (`id_imovel` ASC) VISIBLE,
  INDEX `fk_fisica_has_imovel_fisica1_idx` (`id_pessoa_fisica` ASC, `fisica_rg` ASC) VISIBLE,
  UNIQUE INDEX `id_pessoa_fisica_UNIQUE` (`id_pessoa_fisica` ASC) VISIBLE,
  UNIQUE INDEX `fisica_rg_UNIQUE` (`fisica_rg` ASC) VISIBLE,
  CONSTRAINT `fk_fisica_has_imovel_fisica1`
    FOREIGN KEY (`id_pessoa_fisica` , `fisica_rg`)
    REFERENCES `cadastro_imobiliario_it575`.`fisica` (`id_pessoa` , `rg`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fisica_has_imovel_imovel1`
    FOREIGN KEY (`id_imovel`)
    REFERENCES `cadastro_imobiliario_it575`.`imovel` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
